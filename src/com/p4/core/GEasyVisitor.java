...
public interface GEasyVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GEasyParser#array_assign}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArray_assign(GEasyParser.Array_assignContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GEasyParser#blok}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBlok(GEasyParser.BlokContext ctx);
	/**
